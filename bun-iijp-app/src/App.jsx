...
const TablaJurisprudenciaCSV = lazy(() => import("./pages/datos/TablaJurisprudenciaCSV"));
const WebScrapping = lazy(() => import("./pages/datos/WebScrapping"));
const Usuarios = lazy(() => import("./pages/admin/usuarios/Usuarios"));
const ListaRoles = lazy(() => import("./pages/admin/Roles/ListaRoles"));
...
const AnalisisHome = lazy(() => import("./pages/analisis/AnalisisHome"));
const EstadisticasBasicas = lazy(() => import("./pages/estadisticas-basicas/EstadisticasBasicas"));
const AnalisisBasico = lazy(() => import("./pages/estadisticas-basicas/AnalisisBasico"));
const Busqueda = lazy(() => import("./pages/busqueda/Busqueda"));
const GeneracionRapida = lazy(() => import("./pages/cronologia/GeneracionRapida"));
const CompararDatos = lazy(() => import("./pages/comparar/CompararDatos"));
const CronologiasAvanzadas = lazy(() => import("./pages/cronologia/CronologiasAvanzadas"));
const CronologiasResultados = lazy(() => import("./pages/cronologia/CronologiasResultados"));
const AnalisisAvanzado = lazy(() => import("./pages/analisis/AnalisisAvanzado"));
                  ...
                  <UserContextProvider>
                    <RoleContextProvider>
                      <PermissionContextProvider>
                        <NotificationContextProvider>
                          <main>
                            <Suspense fallback={<p>Cargando chunk...</p>}>
                              <Routes>
                                ...
                                <Route path="/" element={<LayoutPublic />}>
                                  ...
                                  <Route path="busqueda-de-jurisprudencia" element={<CronologiasAvanzadas />} />
