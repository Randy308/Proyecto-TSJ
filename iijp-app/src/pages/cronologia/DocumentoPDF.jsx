...
import Diamond from "../../images/iijp.png";
import Circle from "../../images/facultad.jpeg";
...
const DocumentoPDF = () => (
  <Document>
    <Page style={styles.body}>
      ...
      <View style={styles.sectionPortada}>
        <Image style={styles.imagenPortada} src={Circle} />
        ...
        <Image style={styles.imagenPortada} src={Diamond} />
      </View>

      <View style={styles.tituloPortada}>
      ...
      <Image style={styles.image} src={Diamond} />
      ...
      <Image style={styles.image} src={Circle} />
      <Text style={styles.text}>
