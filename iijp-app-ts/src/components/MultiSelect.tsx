  ...
  return (
    <div className="flex dark:bg-gray-600 relative m-2 justify-between items-center gap-2 border rounded-md py-2 w-auto lg:w-96">
      <div className="ps-1">
        ...
        ): (<div className="text-gray-500 text-xs ps-2">Seleccione los campos donde buscar</div>)}
      </div>
            ...
            (option) =>
              !selectedOptions.includes(option.value) && (
                <label className="group w-full flex" key={option.value}>
                  ...
                  />
                  <span className="flex-1 py-2 text-md ps-2 dark:bg-gray-700 hover:dark:bg-gray-950 hover:bg-red-octopus-300 hover:text-white w-full">
                    {option.label}
                  </span>
                </label>
              )
