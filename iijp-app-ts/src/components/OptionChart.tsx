...
type SingleChartType = "bar" | "line" | "pie" | "scatter" | "area";
type DualChartType = "stackedBar" | "stackedColumn" | "groupedColumn" | "multiLine" | "stackedArea" | "polar" | "radar" | "donut";
type ChartType = SingleChartType | DualChartType;
...
export const OptionChart = ({
  ...
  const singleVariableConfigs:Record<SingleChartType, echarts.EChartsOption> = {
    bar: {
      title: {
  ...
  const dualVariableConfigs:Record<DualChartType, echarts.EChartsOption> = {
    stackedBar: {
      title: {
  ...
  const updateChart = () => {
    ...
    const configs = isMultiVariable
      ...
      : dualVariableConfigs;
    const config: echarts.EChartsOption = configs[chartType as keyof typeof configs];
